        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div>
                ...
                <p class="text-gray-500 mt-1 text-sm">
                    {{ $studentInfo['name'] }} | LRN: {{ $studentInfo['lrn'] }}
                    @if($currentStudent && $currentStudent->status === 'Graduated')
                    <span class="inline-flex items-center ml-2 px-2 py-0.5 rounded-full text-xs font-bold bg-purple-100 text-purple-700 uppercase tracking-wider">Graduated</span>
                    @endif
                    @if($this->isPromoted)
                    <span class="inline-flex items-center ml-2 px-2 py-0.5 rounded-full text-xs font-bold bg-green-100 text-green-700 uppercase tracking-wider">Promoted</span>
                    @endif
                </p>
                @else
            ...
            <div class="flex flex-wrap items-end gap-4">
                ...
                @if($selectedStudentId && $studentInfo && $this->canPromote)
                <div class="flex items-end">
                    <button wire:click="promoteStudent" wire:confirm="Are you sure you want to promote this student to the next school year?"
                ...
                <div class="flex items-end gap-2">
                    ...
                    <button wire:click="exportAttendance"
                        class="inline-flex items-center gap-2 px-4 py-2 bg-indigo-600 text-white text-sm font-semibold rounded-lg shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
