<div class="max-w-6xl mx-auto space-y-6">
    ...
    <!-- Profile Header Card -->
    <div
        class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 flex flex-col md:flex-row items-center justify-between">
        <div class="flex items-center space-x-6">
            <div
                class="h-24 w-24 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center text-4xl font-bold font-serif shadow-inner">
        ...
        <button wire:click="$set('showModal', true)"
            class="mt-6 md:mt-0 bg-blue-600 hover:bg-blue-700 text-white font-medium py-2.5 px-6 rounded-xl shadow-md transition duration-200 flex items-center">
            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M15.232 5.232l3.536 3.536M9 11l2 2m-4 4l2 2m-4 4l4-4m6-10.5L20.5 3.5l-1-1L5 16.5 4 20l3.5-1.5L15.5 8.5z" />
            </svg>
            Edit Profile
        </button>
    </div>
                ...
                @if (count($assignedSections) > 0)
                    <ul class="space-y-4">
                        @foreach ($assignedSections as $section)
                            <li
                                class="flex items-center relative p-4 rounded-xl border border-gray-100 hover:border-blue-200 hover:bg-blue-50 transition duration-150">
                                <div>
    ...
    <div x-data="{ open: @entangle('showModal') }" x-show="open" style="display: none;"
        ...
        <!-- Backdrop -->
        <div class="fixed inset-0 bg-gray-900 bg-opacity-50 backdrop-blur-sm shadow-xl transition-opacity"
        ...
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg z-10 transform overflow-hidden" x-transition>
            ...
            <div class="p-6 space-y-5">
                <div>
                    ...
                    <input type="text" wire:model.defer="firstname"
                        class="block w-full border-gray-300 rounded-xl shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-100 transition py-2.5">
                    @error('firstname')
            ...
            <div class="bg-gray-50 px-6 py-4 flex justify-end space-x-3 rounded-b-2xl">
                <button @click="open = false"
                    class="bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 py-2.5 px-5 rounded-xl font-medium transition shadow-sm">
                    Cancel
                </button>
                <button wire:click="update"
                    class="bg-blue-600 hover:bg-blue-700 text-white py-2.5 px-5 rounded-xl font-medium transition shadow-md flex items-center">
