    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <div class="hidden md:flex md:space-x-4">
                ...
                <a href="{{ route('dashboard') }}" class="{{ request()->routeIs('dashboard') ? 'text-main bg-white' : 'text-white' }} px-4 py-2 rounded-lg hover:bg-white hover:text-main">Dashboard</a>
                <a href="" class="{{ request()->routeIs('enrollment.form') ? 'text-main bg-white' : 'text-white' }} px-4 py-2 rounded-lg hover:bg-white hover:text-main">Enrollment Form</a>
                <a href="" class="{{ request()->routeIs('subjects') ? 'text-main bg-white' : 'text-white' }} px-4 py-2 rounded-lg hover:bg-white hover:text-main">Subjects</a>
